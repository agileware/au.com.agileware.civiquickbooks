...
QBO have recently implemented mandatory OAuth 2.0 authentication for all new QBO applications integrating with QBO. So you must use the oath2.0 branch of QBO to successfully connect CiviQuickBooks to QBO. See [branch oauth2.0](https://github.com/agileware/au.com.agileware.civiquickbooks/tree/oauth2.0)
