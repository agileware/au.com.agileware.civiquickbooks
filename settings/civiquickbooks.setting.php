...
return [
  ...
  'quickbooks_oauth_rate_exceeded' => [
    'group_name' => E::ts('QuickBooks Online Settings'),
    'group' => 'civiquickbooks',
    'name' => 'quickbooks_oauth_rate_exceeded',
    'type' => 'Integer',
    'html_type' => NULL,
    'add' => '2.11',
    'default' => NULL,
    'title' => E::ts('QBO API Rate Limit Exceeded At'),
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Unix timestamp recording when the QBO API rate limit was last exceeded, used to temporarily block further sync API calls.'),
    'help_text' => E::ts('Unix timestamp recording when the QBO API rate limit was last exceeded, used to temporarily block further sync API calls.'),
  ],
