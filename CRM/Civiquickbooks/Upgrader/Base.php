 ...
 */
class CRM_Civiquickbooks_Upgrader_Base {

  /**
   * @var CRM_Civiquickbooks_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Civiquickbooks_Upgrader(
        'au.com.agileware.civiquickbooks',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Civiquickbooks_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Civiquickbooks_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
  ...
  private function deleteDeprecatedRevision() {
    if ($this->revisionStorageIsDeprecated) {
      ...
      $setting->delete();
      CRM_Core_Error::debug_log_message(E::ts("Migrated extension schema revision ID for {$this->extensionName} from civicrm_setting (deprecated) to civicrm_extension.\n"));
    }
  }
